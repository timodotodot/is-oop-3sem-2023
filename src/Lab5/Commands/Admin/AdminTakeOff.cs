...
public class AdminTakeOff : ICommand
{
    private IBankAccountRepository _repository;
    private string _account;
    private double _amountMoney;

    public AdminTakeOff(IBankAccountRepository repository, string account, string amountMoney)
    {
    ...
    public void Execute()
    {
        ...
        _repository.TakeOffMoney(account, _amountMoney);
    }
}