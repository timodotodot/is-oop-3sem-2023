...
public class PcConsumptionMoreThanPowerUnit
{
    [Fact]
    public void PcConsumptionMoreThanPowerUnitTest()
    {
        // Arrange
        ...
        var powerUnit = new PowerUnit("beQuiet 400W", 400);
        ...
        const string comment = "The power PowerUnit is lower than the power consumption of the computer";
